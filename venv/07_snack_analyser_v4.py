...
# ==================================================
    ...
    if check_snack == "Yes":
        ...
        if wanted_snack in valid_snacks[0]:
            snack_price = 2.50

        elif wanted_snack in valid_snacks[1]:
            snack_price = 3.00

        elif wanted_snack in valid_snacks[2]:
            snack_price = 4.50

        elif wanted_snack in valid_snacks[3]:
            snack_price = 4.50

        elif wanted_snack in valid_snacks[4]:
            snack_price = 2.00
